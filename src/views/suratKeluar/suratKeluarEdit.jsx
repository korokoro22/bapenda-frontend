...
export default function suratKeluarEdit(){
    ...
    const handleSubmit = async () => {
        ...
        await axios.post(`http://127.0.0.1/kp2/api-web-bapenda/public/api/surat-keluar/${id}`, data, {headers: {'Content-Type': 'multipart/form-data'}})
            .then(response => {
                console.log(response)
                    ...
                    <div className="flex-grow">
                        <div className="w-11/12 mx-auto my-10 py-4 shadow-md sm:rounded-lg">
                            <div className=" mt-4 w-11/12 mx-auto border-b border-black">
                                <p className="font-inter font-bold ml-7">PEMBAHARUAN SURAT KELUAR</p>
                            </div>
                            <div className="mt-8 w-9/12 mx-auto">
                                <div  className="mx-auto">
                                    ...
                                    <div className=" mt-5 w-full">
                                        ...
                                        <input type="text" className="border-2 border-gray-300 rounded px-3 py-2 w-full" name="kepada" value={tempData.kepada} onChange={handleSubmit} />
                                        </label>
                                    </div>
                                    <div className=" mt-5 w-full">
