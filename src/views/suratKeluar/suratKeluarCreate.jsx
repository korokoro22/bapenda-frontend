...
export default function suratKeluarCreate() {
  ...
  const handleSubmit = async () => {
    ...
    await Api.post(
      "http://127.0.0.1/kp/bapenda-backend/public/api/surat-keluar",
      data,
      ...
      <div className="flex-grow">
        <div className="w-11/12 mx-auto my-10 py-4 shadow-md sm:rounded-lg">
          <div className=" mt-4 w-11/12 mx-auto border-b border-black">
            <p className="font-inter font-bold ml-7">PENAMBAHAN SURAT KELUAR</p>
          </div>
          <div className="mt-8 w-9/12 mx-auto">
            <div className="mx-auto">
              <div className="mt-5 w-full">
                <label className="block mb-2 text-lg font-semibold font-inter">
                  Nomor Surat
                  <input
                    type="text"
                    className="border-2 border-gray-300 rounded px-3 py-2 w-full"
                    name="nosurat"
                    value={suratKeluarInput.nosurat}
              ...
              <div className=" mt-5 w-full">
                <label className="block mb-2 text-lg font-semibold font-inter">
                  ...
                  <input
                    ...
                    className="border-2 border-gray-300 rounded px-3 py-2 w-full"
                    name="tglsurat"
                    value={suratKeluarInput.tglsurat}
                    onChange={handleChange}
                  />
                </label>
              </div>
              <div className=" mt-5 w-full">
                <label className="block mb-2 text-lg font-semibold font-inter">
                  ...
                  <input
                    ...
                    className="border-2 border-gray-300 rounded px-3 py-2 w-full"
                    name="perihal"
                    value={suratKeluarInput.perihal}
                    onChange={handleChange}
                  />
                </label>
              </div>
              <div className=" mt-5 w-full">
                <label className="block mb-2 text-lg font-semibold font-inter">
                  Ringkasan
                  <textarea
                    className="border-2 border-gray-300 rounded px-3 py-2 w-full resize-none"
                    name="isiringkas"
                    value={suratKeluarInput.isiringkas}
                    onChange={handleChange}
                  />
                </label>
              </div>
              <div className=" mt-5 w-full">
                <label className="block mb-2 text-lg font-semibold font-inter">
                  ...
                  <input
                    ...
                    className="border-2 border-gray-300 rounded px-3 py-2 w-full"
                    name="kepada"
                    value={suratKeluarInput.pengirim}
                    onChange={handleChange}
                  />
                </label>
              </div>
              ...
              <div className="my-8 w-full ">
                <button
                  ...
                  className="p-2 rounded-md text-white bg-green-500 mr-2 hover:bg-green-700 font-inter"
                >
                  SIMPAN
                </button>
                <Link
                  to="/surat-keluar"
                  className="p-2 rounded-md bg-gray-400 hover:bg-gray-600 text-white font-inter"
                >
                  KEMBALI
                </Link>
              </div>
