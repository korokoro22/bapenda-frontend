...
export default function arsipPergubCreate() {
  ...
  const handleSubmit = async () => {
    ...
    await Api.post(
      "http://127.0.0.1/kp/bapenda-backend/public/api/arsip-gubernur",
      data,
              ...
              <div className="mt-5 w-full">
                <label className="block mb-2 text-lg font-semibold font-inter">
                  ...
                  <input
                    ...
                    name="nosurat"
                    value={arsipPergubInput.nosurat}
              ...
              <div className=" mt-5 w-full">
                <label className="block mb-2 text-lg font-semibold font-inter">
                  ...
                  <input
                    ...
                    className="border-2 border-gray-300 rounded px-3 py-2 w-full"
                    name="tglsurat"
                    value={arsipPergubInput.tglsurat}
                    onChange={handleChange}
                  />
                </label>
              </div>
              <div className=" mt-5 w-full">
                <label className="block mb-2 text-lg font-semibold font-inter">
                  ...
                  <input
                    ...
                    className="border-2 border-gray-300 rounded px-3 py-2 w-full"
                    name="perihal"
                    value={arsipPergubInput.perihal}
                    onChange={handleChange}
                  />
                </label>
              </div>
              <div className=" mt-5 w-full">
                <label className="block mb-2 text-lg font-semibold font-inter">
                  ...
                  <textarea
                    ...
                    name="isiringkas"
                    value={arsipPergubInput.isiringkas}
                    onChange={handleChange}
                  />
                </label>
              </div>
